...
/* In stack when we try to change one variable data only that data has been changed because when we use refer
it will work on the copy one not on the original variable.
